...
public class ProductControllerTest {
    ...
    void testFindProductsByCriteria1() {
        ...
        assertThat(productList).extracting(ListProductResponse::id, ListProductResponse::name, ListProductResponse::salesUnits, ListProductResponse::stock)
            .contains(
                new Tuple("3d21ffa2-1abc-4e5a-ba95-515773330cf0", "CONTRASTING LACE T-SHIRT", 650, Map.of(Size.S, 0, Size.M, 0, Size.L, 1)),
                new Tuple("4945ee60-ea5d-4466-b9eb-0c97bcf9e959", "V-NECH BASIC SHIRT", 100, Map.of(Size.S, 4, Size.M, 0, Size.L, 9)),
                new Tuple("3caa1263-2d6f-4fc0-99c0-ad213b1e8097", "RAISED PRINT T-SHIRT", 80, Map.of(Size.S, 20, Size.M, 20, Size.L, 2)),
                new Tuple("4bd92219-9f51-4812-8512-ee512003dc70", "CONTRASTING FABRIC T-SHIRT", 50, Map.of(Size.S, 35, Size.M, 9, Size.L, 9)),
                new Tuple("b7d2f0d5-c7aa-4fff-8bfe-c87a2898e4f0", "SLOGAN T-SHIRT", 20, Map.of(Size.S, 9, Size.M, 5, Size.L, 2)),
                new Tuple("9ce84648-5c5c-45b4-bbda-9a23f03a7df7", "PLEATED T-SHIRT", 3, Map.of(Size.S, 25, Size.M, 10, Size.L, 30))
            );
    }
